...
recuperationMusiqueInfoRecherche = Blueprint('recuperationMusiqueInfoRecherche', __name__)
...
@recuperationMusiqueInfoRecherche.route('/recuperationMusiqueInfoRecherche', methods=['GET'])
