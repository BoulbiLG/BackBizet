...
recuperationMusiqueLienRecherche = Blueprint('recuperationMusiqueLienRecherche', __name__)
...
@recuperationMusiqueLienRecherche.route('/recuperationMusiqueLienRecherche', methods=['GET'])
def recuperationMusiqueLien_def():

    db = client['Bizeterie']
    collection = db['musiqueLien']
