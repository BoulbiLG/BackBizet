...
recuperationCommentaire = Blueprint('recuperationCommentaire', __name__)
...
@recuperationCommentaire.route('/recuperationCommentaire', methods=['GET'])
def recuperationCommentaire_def():
